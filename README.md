...
## 1. Designed and implemented an end-to-end analytics solution
Led the development of a fully integrated analytics pipeline within Microsoft Fabric, covering data ingestion, transformation, modelling, and reporting. Established a scalable architecture using structured data models and optimised queries, enabling efficient handling of large-scale taxi trip datasets and ensuring reliable, high-performance reporting.

## 2. Developed standardised reporting frameworks and KPIs
Defined and implemented consistent KPI frameworks (Total Revenue, Trips, Avg Fare, Tip %, Distance), ensuring alignment across all reporting outputs. Introduced standardised metric definitions and naming conventions to improve data consistency, transparency, and stakeholder trust in reporting outputs.

## 3. Delivered actionable business insights to support decision-making
Translated complex datasets into clear, business-focused insights, identifying key trends such as demand seasonality, revenue variation, and high-performing pickup zones. Enabled data-driven decision-making by highlighting opportunities for pricing optimisation, operational efficiency, and improved resource allocation.

## 4. Enhanced data quality and governance controls
Identified and addressed data anomalies, including negative and inconsistent fare values, by implementing validation checks and data cleansing logic. Strengthened data governance practices to ensure accuracy, reliability, and auditability of reporting outputs, reducing the risk of misleading insights.

## 5. Optimised dashboard design and user experience for stakeholders
Designed an intuitive and visually consistent Power BI dashboard, incorporating filters, drilldowns, and interactive visuals to enhance usability. Applied best practices in data visualisation and report standardisation, enabling stakeholders to quickly interpret insights and interact with the data effectively.
...
# Key Contributions
## 1. Development and Calculation of Key Performance Indicators (KPIs) 📊
...
## 2. Transformation of Raw Transactional Data into Actionable Insights 🔍
...
## 3. Customer Segmentation and Behavioural Analysis 👥
...
## 4. Product, Store, and Channel Performance Evaluation 🛍️📍
...
## 5. Translation of SQL Analysis into Business-Focused Recommendations 🚀
Beyond technical query development, I translated SQL outputs into clear, business-relevant insights aligned with Aurelia Styles’ strategic objectives. This ensured that analytical findings could be readily used to inform decisions on inventory planning, promotional effectiveness, customer engagement, and overall business growth. My contribution supports the adoption of a data-driven decision-making approach across the organisation.
